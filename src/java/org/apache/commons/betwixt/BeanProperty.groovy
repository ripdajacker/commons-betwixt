...
public class BeanProperty {
    ...
    public Descriptor createXMLDescriptor(IntrospectionConfiguration configuration) {
        ...
        log.trace("Creating descriptor for property: name=$propertyName type=$propertyType")
    ...
    private ElementDescriptor createDescriptorForMap(
        ...
        if (configuration.isWrapCollectionsInElement()) {
            ...
            wrappingDescriptor.setElementDescriptors([entryDescriptor])
            NameMapper nameMapper = configuration.getElementNameMapper()
    ...
    private ElementDescriptor createDescriptorForCollective(IntrospectionConfiguration configuration,
        ...
        if (configuration.isWrapCollectionsInElement()) {
            ...
            ElementDescriptor wrappingDescriptor = new ElementDescriptor()
            wrappingDescriptor.setElementDescriptors([loopDescriptor])
