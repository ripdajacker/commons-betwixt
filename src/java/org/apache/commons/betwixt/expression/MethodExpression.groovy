...
public class MethodExpression implements Expression {
     ...
     * null classes
     */
    private static final Class[] NULL_CLASSES = new Class[0]
    ...
    public Object evaluate(Context context) {
        ...
        if (bean != null) {
            Object[] arguments = NULL_ARGUMENTS
            try {
     ...
     */
    private static Method findAlternateMethod(
            Class type,
            Method method) {
        Class[] interfaces = type.getInterfaces()
        if (interfaces != null) {
            String name = method.getName()
            for (Class otherType : interfaces) {
                try {
     ...
     * @since 0.8
     */
    private static void handleException(Context context, Exception e, Method m) {
