...
public class XMLUtils {
    ...
    static {
        ...
        for (int aNameStartChar : nameStartChar) {
            CHARS[aNameStartChar] |= MASK_NAME_START | MASK_NAME;
        }
        ...
        for (int aLetterChar : letterChar) {
            CHARS[aLetterChar] |= MASK_NAME_START | MASK_NAME;
        }

        // set name characters
        for (int aNameChar : nameChar) {
            CHARS[aNameChar] |= MASK_NAME;
        }
        ...
        for (int aCombiningCharChar : combiningCharChar) {
            CHARS[aCombiningCharChar] |= MASK_NAME;
        }
        ...
        for (int anExtenderChar : extenderChar) {
            CHARS[anExtenderChar] |= MASK_NAME;
        }
     ...
     */
    public static String escapeBodyValue(Object value) {
     ...
     */
    public static String escapeCDATAContent(String content) {
     ...
     *                        section of xml
     */
    public static void escapeCDATAContent(StringBuffer bufferedContent) {
