   ...
   public void begin(String name, String namespace, Attributes attributes)
      ...
      if (implementationClass != null) {
         try {
            ...
            throw new SAXException(
                  "Cannot load class named: "
                        + implementationClass);
         }
      }

      if (propertyName != null && propertyName.length() > 0) {
         boolean forceAccessible = "true".equals(
               attributes
                     .getValue("forceAccessible"));
         configureDescriptor(
               descriptor, attributes.getValue("updater"),
               forceAccessible);
      ...
      if (top instanceof XMLBeanInfo) {
         ...
         throw new SAXException(
               "Invalid use of <element>. It should "
      ...
      if (updateMethodName == null) {
         ...
         if (updateMethod == null) {
            if (log.isInfoEnabled()) {
               ...
               log.info(
                     "No method with name '" + updateMethodName
                           + "' found for update");
            }
         } else {
