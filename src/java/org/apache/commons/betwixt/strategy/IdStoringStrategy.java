...
public abstract class IdStoringStrategy {
    ...
    */
   public abstract String getReferenceFor(Object bean);
    ...
    *            the id to use
    */
   public abstract void setReference(Object bean, String id);
    ...
    */
   public abstract Object getReferenced(String id);
