...
public class ReadContext extends Context implements AbstractReadContext {
    ReadContextEventListener listener = new NoopListener();
    ...
    public ReadContext(BindingConfiguration bindingConfiguration, ReadConfiguration readConfiguration) {
        this(null, LogFactory.getLog(ReadContext.class), bindingConfiguration, readConfiguration);
    }
     ...
     * @param readConfiguration    the extra read configuration not null
     */
    public ReadContext(ReadContextEventListener listener, Log log, BindingConfiguration bindingConfiguration, ReadConfiguration readConfiguration) {
    ...
    public String popElement() {
        ...
        if (!descriptorStack.isEmpty()) {
            listener.descriptorPopped(this, (ElementDescriptor) descriptorStack.pop());
        }
        ...
        String result = (String) top;
        listener.elementPopped(this, result);
        return result;
    }
    ...
    public void pushElement(String elementName) throws Exception {
        listener.elementPushed(this, elementName);
        ...
        listener.descriptorPushed(this, nextDescriptor);
        pushOptions(options);
    ...
    public void markClassMap(Class mappedClazz) throws IntrospectionException {
        ...
        listener.elementClassPushed(this, mappedClazz);
        ...
        listener.descriptorPushed(this, mappedElementDescriptor);

        Updater updater = mappedElementDescriptor.getUpdater();
        updaterStack.push(updater);
        listener.updaterPushed(this, updater);
    }
    ...
    public MappingAction popMappingAction() {
        MappingAction pop = (MappingAction) actionMappingStack.pop();
        listener.actionMappingPopped(this, pop);
        return pop;
    }
    ...
    public void pushMappingAction(MappingAction mappingAction) {
        ...
        listener.actionMappingPushed(this, mappingAction);
    }
    ...
    public void populateAttributes(
        ...
        if (attributeDescriptors != null) {
            for (AttributeDescriptor attributeDescriptor : attributeDescriptors) {
                String value;
                if (attributes instanceof AttributesWithContext) {
                    AttributesWithContext withContext = (AttributesWithContext) attributes;
                    value = withContext.getValue(attributeDescriptor.getLocalName(), attributeDescriptor);
                } else {
    ...
    public Updater popUpdater() {
        Updater pop = (Updater) updaterStack.pop();
        listener.updaterPopped(this, pop);
        return pop;
    }
                            ...
                            for (ElementDescriptor descriptor : parent.getElementDescriptors()) {
                                if (descriptor.isPolymorphic()) {
                                    ...
                                    if (result != null) {
                                        ...
                                        listener.descriptorPushed(this, descriptor);
    ...
    /**
     * A listener with no function.
     */
    private static final class NoopListener implements ReadContextEventListener {

        @Override
        public void descriptorPushed(ReadContext readContext, ElementDescriptor descriptor) {

        }

        @Override
        public void descriptorPopped(ReadContext readContext, ElementDescriptor descriptor) {

        }

        @Override
        public void beanPushed(ReadContext readContext, Object bean) {

        }

        @Override
        public void beanPopped(ReadContext readContext, Object bean) {

        }

        @Override
        public void elementClassPushed(ReadContext readContext, Class clazz) {

        }

        @Override
        public void elementPushed(ReadContext readContext, String elementName) {

        }

        @Override
        public void elementPopped(ReadContext readContext, String elementName) {

        }

        @Override
        public void updaterPushed(ReadContext readContext, Updater updater) {

        }

        @Override
        public void updaterPopped(ReadContext readContext, Updater updater) {

        }

        @Override
        public void actionMappingPushed(ReadContext readContext, MappingAction action) {

        }

        @Override
        public void actionMappingPopped(ReadContext readContext, MappingAction action) {
