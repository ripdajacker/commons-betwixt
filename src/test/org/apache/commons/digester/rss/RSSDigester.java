...
public class RSSDigester extends Digester {
   ...
   protected void configure() {
      ...
      addSetNext(
            "rss/channel/textinput", "setTextInput",
            "org.apache.commons.digester.rss.TextInput");
      addCallMethod(
