...
public class TestWriteClass extends AbstractTestCase {
   ...
   public void testDotBetwixtClass() throws Exception {
      ...
      xmlAssertIsomorphicContent(
            "Expected only class name to be mapped",
   ...
   public void testPropertySuppressionStrategy() throws Exception {
      ...
      BeanWithSecrets bean = new BeanWithSecrets(
            "Surveyor Of The Queen's Pictures", "Queen Elizabeth II",
      ...
      writer.getIntrospector().getConfiguration().setPropertySuppressionStrategy(
            new PropertySuppressionStrategy() {
               ...
               public boolean suppressProperty(
                     Class classContainingThePropety,
                     Class propertyType,
                     String propertyName) {
      ...
      xmlAssertIsomorphicContent(
            "Expected secrets to be supressed",
            parseString(expected),
            parseString(out.toString()),
            true);
