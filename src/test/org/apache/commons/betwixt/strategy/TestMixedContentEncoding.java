...
public class TestMixedContentEncoding extends AbstractTestCase {
   ...
   public void testBaseMixedCDATAEncoding() {
      ...
      assertEquals(
            ...
            "<![CDATA[<greeting>ab]]&gt;ba</greeting>]]>",
            mceStrategy.encodeInCDATA("<greeting>ab]]>ba</greeting>"));
   }
   ...
   public void testDefaultImplementation() {
      ...
      assertEquals(
            ...
            MixedContentEncodingStrategy.DEFAULT.encode(
                  "<proclaim>The King Is Dead, Long Live The King</proclaim>",
                  descriptor));
   }
   ...
   public void testEscapedCharactersImplementation() {
      ...
      assertEquals(
            "Default implementation uses character escaping",
            "&lt;proclaim&gt;The King Is Dead, Long Live The King&lt;/proclaim&gt;",
            MixedContentEncodingStrategy.ESCAPED_CHARACTERS.encode(
                  "<proclaim>The King Is Dead, Long Live The King</proclaim>",
                  descriptor));
   }
   ...
   public void testCDATAImplementation() {
      ...
      assertEquals(
            ...
            MixedContentEncodingStrategy.CDATA.encode(
                  "<proclaim>The King Is Dead, Long Live The King</proclaim>",
                  descriptor));
   }
